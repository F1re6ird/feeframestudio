...
export default function UpdateTestimony({ userId, id }: { userId: string, id: string }) {

    const { data } = useFetch<test>(`/api/testimony/${id}`);
    console.log(data)
        ...
        <div className="w-full min-h-screen overflow-y-auto">
            ...
            <form className="p-6 space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                    <Link href={`/dashboard/wall-of-love`}>
                        <button
                            type="button"
                    ...
                    >
                        {loading ? "Uploading..." : "Update Testimonials"}
                    </button>
                </div>
            </form>
        </div>
