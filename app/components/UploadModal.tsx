...
export default function UploadModal({ userId }: { userId: string }) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const publicIds = [
                    ...videoUploads.map((f) => f.publicId),
                    ...photoUploads.map((f) => f.publicId),
                    ...designUploads.map((f) => f.publicId),
                ];

                await fetch("/api/deleteFromCloudinary", {
                    method: "POST",
                    headers: { "Content-Type": "application/json" },
            ...
            <form className="p-6 space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                    ...
                    <button
                        ...
                        className={`px-4 py-2 text-sm font-medium rounded-md ${loading || selected.length === 0
